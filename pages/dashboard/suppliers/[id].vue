<template>
  <!-- Cancela solo el padding bottom del dashboard main. Sin margen horizontal para no tapar el sidebar de navegación -->
  <div class="-mb-4 lg:-mb-6 flex flex-col overflow-hidden h-[calc(100dvh-5rem)] lg:h-[calc(100dvh-5.5rem)]">
